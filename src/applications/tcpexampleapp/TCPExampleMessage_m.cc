//
// Generated file, do not edit! Created by opp_msgc 4.1 from applications/tcpexampleapp/TCPExampleMessage.msg.
//
...
TCPExampleMessage::TCPExampleMessage(const TCPExampleMessage& other) : cPacket()
{
...
void TCPExampleMessage::setType(int type_var)
{
...
void TCPExampleMessage::setSenderAddress(const TransportAddress& senderAddress_var)
{
