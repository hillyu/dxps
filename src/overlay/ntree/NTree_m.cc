//
// Generated file, do not edit! Created by opp_msgc 4.1 from overlay/ntree/NTree.msg.
//
...
NTreeJoinCall::NTreeJoinCall(const NTreeJoinCall& other) : BaseCallMessage()
{
...
void NTreeJoinCall::setPosition(const Vector2D& position_var)
{
...
NTreeJoinResponse::NTreeJoinResponse(const NTreeJoinResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    members_arraysize = 0;
    this->members_var = 0;
...
void NTreeJoinResponse::setOrigin(const Vector2D& origin_var)
{
...
void NTreeJoinResponse::setSize(double size_var)
{
...
void NTreeJoinResponse::setMembers(unsigned int k, const NodeHandle& members_var)
{
    if (k>=members_arraysize) throw cRuntimeError("Array of size %d indexed by %d", members_arraysize, k);
...
NTreeDivideCall::NTreeDivideCall(const NTreeDivideCall& other) : BaseCallMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeDivideCall::setOrigin(const Vector2D& origin_var)
{
    this->origin_var = origin_var;
}
...
void NTreeDivideCall::setSize(double size_var)
{
    this->size_var = size_var;
}
...
void NTreeDivideCall::setQuadrant(int quadrant_var)
{
    this->quadrant_var = quadrant_var;
}
...
NTreeDivideResponse::NTreeDivideResponse(const NTreeDivideResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeDivideResponse::setQuadrant(int quadrant_var)
{
    this->quadrant_var = quadrant_var;
}
...
NTreePingCall::NTreePingCall(const NTreePingCall& other) : BaseCallMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreePingCall::setOrigin(const Vector2D& origin_var)
{
    this->origin_var = origin_var;
}
...
void NTreePingCall::setSize(double size_var)
{
    this->size_var = size_var;
}
...
void NTreePingCall::setParent(const NodeHandle& parent_var)
{
...
NTreeNodePingCall::NTreeNodePingCall(const NTreeNodePingCall& other) : NTreePingCall()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeNodePingCall::setSiblings(unsigned int k, const NodeHandle& siblings_var)
{
    if (k>=4) throw cRuntimeError("Array of size 4 indexed by %lu", (unsigned long)k);
...
void NTreeNodePingCall::setQuadrant(int quadrant_var)
{
    this->quadrant_var = quadrant_var;
}
...
NTreePingResponse::NTreePingResponse(const NTreePingResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    operator=(other);
}
...
NTreeNodePingResponse::NTreeNodePingResponse(const NTreeNodePingResponse& other) : NTreePingResponse()
{
    setName(other.getName());
    members_arraysize = 0;
    this->members_var = 0;
...
void NTreeNodePingResponse::setMembers(unsigned int k, const NodeHandle& members_var)
{
    if (k>=members_arraysize) throw cRuntimeError("Array of size %d indexed by %d", members_arraysize, k);
    this->members_var[k]=members_var;
}
...
void NTreeNodePingResponse::setAggChildCount(int aggChildCount_var)
{
    this->aggChildCount_var = aggChildCount_var;
}
...
NTreeGroupDeleteMessage::NTreeGroupDeleteMessage(const NTreeGroupDeleteMessage& other) : BaseOverlayMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeGroupDeleteMessage::setOrigin(const Vector2D& origin_var)
{
    this->origin_var = origin_var;
}
...
void NTreeGroupDeleteMessage::setSize(double size_var)
{
    this->size_var = size_var;
}
...
void NTreeGroupDeleteMessage::setNewChild(unsigned int k, const NodeHandle& newChild_var)
{
    if (k>=4) throw cRuntimeError("Array of size 4 indexed by %lu", (unsigned long)k);
    this->newChild_var[k] = newChild_var;
}
...
NTreeCollapseMessage::NTreeCollapseMessage(const NTreeCollapseMessage& other) : BaseOverlayMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeCollapseMessage::setOrigin(const Vector2D& origin_var)
{
    this->origin_var = origin_var;
}
...
void NTreeCollapseMessage::setSize(double size_var)
{
    this->size_var = size_var;
}
...
void NTreeCollapseMessage::setPlayer(const NodeHandle& player_var)
{
...
NTreeLeaveMessage::NTreeLeaveMessage(const NTreeLeaveMessage& other) : BaseOverlayMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeLeaveMessage::setPlayer(const NodeHandle& player_var)
{
    this->player_var = player_var;
}
...
void NTreeLeaveMessage::setPosition(const Vector2D& position_var)
{
    this->position_var = position_var;
}
...
NTreeMoveMessage::NTreeMoveMessage(const NTreeMoveMessage& other) : BaseOverlayMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeMoveMessage::setPlayer(const NodeHandle& player_var)
{
    this->player_var = player_var;
}
...
void NTreeMoveMessage::setPosition(const Vector2D& position_var)
{
    this->position_var = position_var;
}
...
NTreeGroupAddMessage::NTreeGroupAddMessage(const NTreeGroupAddMessage& other) : BaseOverlayMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeGroupAddMessage::setPlayer(const NodeHandle& player_var)
{
    this->player_var = player_var;
}
...
void NTreeGroupAddMessage::setOrigin(const Vector2D& origin_var)
{
    this->origin_var = origin_var;
}
...
NTreeReplaceNodeMessage::NTreeReplaceNodeMessage(const NTreeReplaceNodeMessage& other) : BaseOverlayMessage()
{
    setName(other.getName());
    children_arraysize = 0;
    this->children_var = 0;
...
void NTreeReplaceNodeMessage::setOrigin(const Vector2D& origin_var)
{
    this->origin_var = origin_var;
}
...
void NTreeReplaceNodeMessage::setSize(double size_var)
{
    this->size_var = size_var;
}
...
void NTreeReplaceNodeMessage::setParent(const NodeHandle& parent_var)
{
    this->parent_var = parent_var;
}
...
void NTreeReplaceNodeMessage::setChildren(unsigned int k, const NodeHandle& children_var)
{
    if (k>=children_arraysize) throw cRuntimeError("Array of size %d indexed by %d", children_arraysize, k);
...
void NTreeReplaceNodeMessage::setOldNode(const TransportAddress& oldNode_var)
{
    this->oldNode_var = oldNode_var;
}
...
void NTreeReplaceNodeMessage::setIsLeaf(bool isLeaf_var)
{
    this->isLeaf_var = isLeaf_var;
}
...
NTreeTakeOverMessage::NTreeTakeOverMessage(const NTreeTakeOverMessage& other) : BaseOverlayMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NTreeTakeOverMessage::setOrigin(const Vector2D& origin_var)
{
    this->origin_var = origin_var;
}
...
void NTreeTakeOverMessage::setSize(double size_var)
{
    this->size_var = size_var;
}
...
void NTreeTakeOverMessage::setPlayer(const NodeHandle& player_var)
{
    this->player_var = player_var;
}
