...
class NTreeJoinResponse : public ::BaseResponseMessage
{
  ...
  public:
    ...
    virtual void setMembers(unsigned int k, const NodeHandle& members_var);
};
...
class NTreeNodePingResponse : public ::NTreePingResponse
{
  ...
  public:
    ...
    virtual void setAggChildCount(int aggChildCount_var);
};
...
class NTreeGroupDeleteMessage : public ::BaseOverlayMessage
{
  ...
  public:
    ...
    virtual void setNewChild(unsigned int k, const NodeHandle& newChild_var);
};
